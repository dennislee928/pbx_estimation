...
const translations = {
  zh: {
    ...
    lifecycleNecessity: "必要性檢定（生命週期）",
    securityIntegration: "必要性檢定（資安與整合）",
  ...
  en: {
    ...
    lifecycleNecessity: "Necessity Test (Lifecycle)",
    securityIntegration: "Necessity Test (Security & Integration)",
    ...
    report11: "Necessity Test — Lifecycle",
    report12: "Necessity Test — Security & Integration",
    languageToggle: "繁體中文",
    loading: "Loading...",
    overview: "Overview",
